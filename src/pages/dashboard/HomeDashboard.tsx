...
export default function HomeDashboard() {
  ...
  const cards: StatCard[] = [
    ...
    },
    {
      label: "Escenarios",
      subtitle: "Modelos 3D",
      icon: <ThreeDRotationIcon sx={{ fontSize: 48 }} />,
    ...
    {
      label: "Minijuegos",
      subtitle: "Gestión sets",
      icon: <SportsEsportsIcon sx={{ fontSize: 48 }} />,
      route: "/dashboard/minigames", // ← nuevo
      color: "#F59E0B",
      role: "any", // ← nuevo
    },
    {
      label: "Cuestionarios",
      subtitle: "Preguntas y sets",
    ...
    {
      label: "Recompensas",
      subtitle: "Premios y puntos",
      icon: <EmojiEventsIcon sx={{ fontSize: 48 }} />,
      route: "/dashboard/rewards",
      color: "#EC4899",
      role: "any", // solo admin puede gestionar
    },
  ];
